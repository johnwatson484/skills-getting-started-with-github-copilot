...
activities = {
    ...
    "Music Band": {
        ...
        "schedule": "Mondays, Thursdays, Fridays, 3:30 PM - 4:30 PM",
        "max_participants": 25,
        "participants": ["mason@mergington.edu", "grace@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        ...
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "ethan@mergington.edu", "mia@mergington.edu"]
    }
}
